...
@section('content')
    ...
    <div class="register-box">
        ...
        <div class="register-box-body">
            <p class="login-box-msg">Registrar-me com a nou usuari</p>
            <form action="{{ url('/register') }}" method="post">
                ...
                <div class="form-group has-feedback">
                    <input type="password" class="form-control" placeholder="Repeteix la contrassenya" name="password_confirmation"/>
                ...
                <div class="row">
                    <div class="col-xs-8">
                        <div class="checkbox icheck">
                            <label>
                                <input type="checkbox"> Accepto els termes <a href="https://formaldocs.com/2014/12/Modelo-de-condiciones-de-uso-de-una-pagina-web">termes</a>
                            </label>
                        </div>
                    </div><!-- /.col -->
                    <div class="col-xs-4">
            ...
            <a href="{{ url('/login') }}" class="text-center">Ja soc usuari</a>
        </div><!-- /.form-box -->
    </div><!-- /.register-box -->
